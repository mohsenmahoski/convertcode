...
foreach ($products as $product) {
 $details .= PHP_EOL.'"admin","base","Default","simple","4,'.$product['cat'].'","ch'.$product['id'].'","0","'.$product['title'].'","متا","فوق توصیف","/1/_/'.$product['pic1'].'","/1/_/'.$product['pic1'].'","/1/_/'.$product['pic1'].'","کلید","کلید/","","بدون به روز رسانی‌های آرایش","ستون اطلاعات محصول","","","","اروگوئه","استفاده از پیکربندی","استفاده از پیکربندی","خیر","1000.0000","99999.0000","88888.0000","","ممکن‌شده","کاتالوگ، جستجو","برند2","بلی","تایید شده","555555","555555","هیچ یک","خیر","توصیف","شرح کوتاه","فوق واژه","","2017-08-12 00:00:00","2017-09-12 00:00:00","2017-08-12 00:00:00","2017-11-12 00:00:00","","","10.0000","0.0000","1","0","0","1","1.0000","1","0.0000","1","1","","0.0000","1","0","1","0","1","0.0000","1","0","0","0","1","محصول","0","simple","","","","","","",""';
}
